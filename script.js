document.addEventListener('DOMContentLoaded', function () {
  ...
  var profileData = {
    'Adrian Brink': {
      ...
      handle: '@adrianbrink',
      title:
        'Pragmatic Idealist: You Are the Bridge Between What Is and What Could Be',
      traits: [
    ...
    awa: {
      ...
      traits: [
        ...
        'Privacy-Advocating and Principled',
      ],
    },
    Maurice: {
    ...
    ASJ: {
      ...
      traits: [
        ...
        'Community-Oriented and Inclusive',
        'Culturally Engaged and Eclectic',
        'Passionated and Enthusiastic',
  ...
  optionButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      ...
      var previouslySelectedButton = currentOptionsContainer.querySelector(
  ...
  function showFinalResult() {
    ...
    personalityTraitsSection.querySelector('h3').textContent =
      'Same Personality Traits as ' + lastResultType;
  ...
  shareOnXButton.addEventListener('click', function () {
    if (lastResultType) {
      ...
      var tweetText =
        'Just completed the Anomage Quiz by @watzenweb3 and learned that ' +
        resultHandle +
        ', ' +
        resultTitleText +
        ', is the closest person to me. Would you like to learn too? > ' +
        quizLink;
      ...
      console.error(
        'Result type is not defined. Please complete the quiz first.'
      );
    }
  });
